    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header bg-warning text-dark">
                <h5 class="mb-0"><i class="bi bi-pencil"></i> Form Edit Barang</h5>
            </div>
            <div class="card-body">
                @if ($errors->any())
                ...
                <form action="{{ route('barang.update', $barang->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('kategori') is-invalid @enderror" 
                            ...
                            <option value="Lainnya" {{ old('kategori', $barang->kategori) == 'Lainnya' ? 'selected' : '' }}>Lainnya</option><div class="row">
